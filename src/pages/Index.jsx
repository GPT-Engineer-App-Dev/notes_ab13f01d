    ...
    <Box p={4}>
      ...
      <Stack spacing={4}>
        {notes.map((note, index) => (
          <Box key={index} p={4} borderWidth={1} borderRadius="md" backgroundColor={useColorModeValue("gray.100", "gray.700")}>
            <Flex justify="space-between" align="center">
              <Heading as="h2" size="md">
                {note.title}
              </Heading>
              <Button leftIcon={<FaTrash />} size="sm" colorScheme="red" onClick={() => deleteNote(index)}>
                Delete
              </Button>
            </Flex>
